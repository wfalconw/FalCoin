(function () {
  ...
  function getTelegramParams(){
    return JSON.stringify(window.TelegramGameProxy.initParams);
  }
  ...
  function getQueryString() {
    ...
    return JSON.stringify(query_string);
  }

  function getIsTelegram() {
    var qs = getQueryString();
    var toret = (!!qs.idchat || !!qs.messageid || !!qs.userid);
    return JSON.stringify(toret);
  }

  function traceJS(obj){
    console.log(obj);
  }
